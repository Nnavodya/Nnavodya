...
![My Skills](https://skillicons.dev/icons?i=php,nodejs,mongodb,mysql,python)

---

### 🛠 Tools & Technologies

![My Skills](https://skillicons.dev/icons?i=mongodb,mysql,postman,git,github,docker,aws,vscode,figma)
